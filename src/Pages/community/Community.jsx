              ...
              <div className="w-full rounded-md">
                <div className="flex w-full h-full relative">
                  <div className=" head w-full">
                    <h1 className="text-center font-semibold text-[30px] py-3">
                      Community Chat
                    </h1>
                    <div className="py-2">
                      <div className="h-[80vh] w-full bg-gray-300 rounded-md py-4 overflow-y-auto">
                        <div className="w-full flex justify-start items-center">
                          <div className="flex justify-start items-start gap-2 md:px-3 py-2 max-w-full lg:max-w-[85%]">
                            ...
                            <div className=" name chat flex justify-center items-start flex-col lg:w-full w-[80%] bg-green-500 shadow-lg shadow-orange-500/50 text-white py-1 px-2 rounded-sm">
                              <h1 className=" text-black font-semibold">BLOG</h1>
                              <p>Stark</p>
                              <span>
                                Lorem ipsum dolor sit amet consectetur
                                adipisicing elit. Ipsam voluptatem commodi,
                                itaque ea nihil iste sapiente. Sequi illum harum
                                similique quam pariatur mollitia deleniti
                                ducimus ea quibusdam, vitae totam reiciendis?
                              </span>
                            </div>
                          </div>
                        </div>
                        <div className="w-full flex justify-end items-center">
                          <div className="chat-a flex justify-start items-start gap-2 md:px-3 py-2 max-w-full lg:max-w-[85%]">
                            <div className=" name flex justify-center items-end flex-col w-[80%] bg-blue-500 shadow-lg shadow-blue-500/50 text-white py-1 px-2 rounded-sm">
                    ...
                    <form className="  flex gap-3">
                      <div className="  w-full flex">
                        ...
                        <select
                          ...
                          className="border-slate-700 outline-none bg-[#d1d5db]"
                        >
          ...
          <div className="lg:w-[25%]">
            ...
            <div className="flex flex-col lg:h-[80vh] px-2 overflow-y-auto gap-2">
              <div className="flex gap-2 items-center bg-[#d1d5db] py-2 px-2 w-[98%] mx-auto rounded-md">
                <img
                  src="https://images.pexels.com/photos/6787391/pexels-photo-6787391.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2"
                  alt=""
